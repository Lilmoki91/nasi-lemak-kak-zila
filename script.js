...
async function fetchShopSettings() {
    try {
        ...
        if (snap.exists()) {
            const d = snap.data();
            ownerMode = d.mode || 'AUTO';
            currentMemo = d.memo || '';
            currentMode = d.mode || 'AUTO';
            return d;
        }
    } catch(e) {
        console.log('Gagal fetch shop settings, guna default');
    }
    return { mode: 'AUTO', memo: '' };
}

// ==============================================
// ⏰ WAKTU OPERASI - FIREBASE
// ==============================================
